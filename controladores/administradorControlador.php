<?php
    ...
    class administradorControlador extends administradorModelo{
                ...
                if($password1 != $password2){
                    ...
                    if($ec >= 1){
                        $alerta = [
                            "Alerta" => "simple",
                            "Titulo" => "Ocurrió un error inesperado",
                            "Texto" => "El email introducido ya está registrado en el sistema, por favor intente nuevamente.",
                            "Tipo" => "error"
                        ];
                    }else{
                        ...
                        if($consulta3->rowCount() >= 1){
                            $alerta = [
                                "Alerta" => "simple",
                                "Titulo" => "Ocurrió un error inesperado",
                                "Texto" => "El usuario introducido ya está registrado en el sistema, por favor intente nuevamente.",
                                "Tipo" => "error"
                            ];
                        }else{
                            ...
                            if($guardarCuenta->rowCount() >= 1){
                                ...
                                if($guardarAdmin->rowCount() >= 1){
                                    $alerta = [
                                        ...
                                        "Texto" => "El administrador se ha registrado exitosamente.",
                                        "Tipo" => "success"
                                    ];
                                }else{
        ...
        //controlador para traer datos del administrador
        ...
        //controlador para actualizar administrador
