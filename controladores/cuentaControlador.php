...
class cuentaControlador extends mainModel{
    ...
    public function actualizar_cuenta_controlador(){
        ...
        $query1 = mainModel::conectar()->prepare("SELECT * FROM cuenta WHERE CuentaCodigo = '$CuentaCodigo' ");
        $query1->execute();
        ...
        if($user != "" && $password != ""){
            ...
            if($login->rowCount() == 0){
                $alerta = [
                    ...
                    "Texto" => "El usuario y la contraseña introducidos no coinciden con los datos de su cuenta.",
                    "Tipo" => "error"
                ];
            ...
            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrió un error inesperado",
                "Texto" => "Para actualizar los datos de la cuenta debe proporcionar el nombre de usuario y la contraseña, por favor ingrese los datos e intente nuevamente.",
                "Tipo" => "error"
            ];
        ...
        if(mainModel::actualizar_cuenta($datosUpdate)){
            ...
            $alerta = [
                ...
                "Texto" => "Los datos de la cuenta se actualizaron correctamente.",
                "Tipo" => "success"
            ];
        }else{
            $alerta = [
