    ...
    class administradorModelo extends mainModel{
        ...
        protected function agregar_administrador_modelo($datos){
            ...
            $sql = mainModel::conectar()->prepare("INSERT INTO 
                admin(AdminNombre, AdminApellido, AdminTelefono, AdminDireccion, CuentaCodigo)
                VALUES(:Nombre, :Apellido, :Telefono, :Direccion, :Codigo) ");
        ...
        protected function actualizar_administrador_modelo($datos){
            ...
            "UPDATE admin 
            SET AdminNombre = :Nombre, AdminApellido = :Apellido, AdminTelefono = :Telefono, AdminDireccion = :Direccion 
