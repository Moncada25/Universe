		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
								<div class="radio radio-primary">
									<label>
                                        <input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(1); ?>"
                                        <?php
								...
								<div class="radio radio-primary">
									<label>
                                        <input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(2); ?>"
                                        <?php
								...
								<div class="radio radio-primary">
									<label>
                                        <input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(3); ?>"
                                        <?php
